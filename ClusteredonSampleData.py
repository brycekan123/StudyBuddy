...
#                 index_to_delete = i
#                 definiteMatch = []
#                 definiteMatch.append(matched_criteria)
...
#         group_pref_2,index_to_delete,result_list,templist,groupsize,unmatched_group,first_row,selected_day
#         )
#     )
# print(result_list)
...
while len(group_pref_3) > 0:
    ...
    group_pref_3,result_list,unmatched_group,templist,selected_day = (
        MatchingFunctions.finishGroup(
        group_pref_3,index_to_delete,result_list,templist,groupsize,unmatched_group,first_row,selected_day
        )
    )
